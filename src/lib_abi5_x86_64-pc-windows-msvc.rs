...
pub const CEC_LIB_VERSION_MAJOR: u32 = 5;
pub const CEC_LIB_VERSION_MAJOR_STR: &[u8; 2] = b"5\0";
...
pub const UNRECOGNIZED_OPCODE: cec_abort_reason = 0;
#[doc = "!< CEC_ABORT_REASON_NOT_IN_CORRECT_MODE_TO_RESPOND"]
pub const NOT_IN_CORRECT_MODE_TO_RESPOND: cec_abort_reason = 1;
#[doc = "!< CEC_ABORT_REASON_CANNOT_PROVIDE_SOURCE"]
pub const CANNOT_PROVIDE_SOURCE: cec_abort_reason = 2;
#[doc = "!< CEC_ABORT_REASON_INVALID_OPERAND"]
pub const INVALID_OPERAND: cec_abort_reason = 3;
#[doc = "!< CEC_ABORT_REASON_REFUSED"]
pub const REFUSED: cec_abort_reason = 4;
pub const CABLE: cec_analogue_broadcast_type = 0;
pub const SATELLITE: cec_analogue_broadcast_type = 1;
pub const TERRESTIAL: cec_analogue_broadcast_type = 2;
pub const RATE_CONTROL_OFF: cec_audio_rate = 0;
pub const STANDARD_RATE_100: cec_audio_rate = 1;
pub const FAST_RATE_MAX_101: cec_audio_rate = 2;
pub const SLOW_RATE_MIN_99: cec_audio_rate = 3;
pub const STANDARD_RATE_100_0: cec_audio_rate = 4;
pub const FAST_RATE_MAX_100_1: cec_audio_rate = 5;
pub const SLOW_RATE_MIN_99_9: cec_audio_rate = 6;
pub const MUTE_STATUS_MASK: cec_audio_status = 128;
pub const VOLUME_STATUS_MASK: cec_audio_status = 127;
pub const VOLUME_MIN: cec_audio_status = 0;
pub const VOLUME_MAX: cec_audio_status = 100;
pub const VOLUME_STATUS_UNKNOWN: cec_audio_status = 127;
pub const CEC_FALSE: cec_boolean = 0;
pub const CEC_TRUE: cec_boolean = 1;
pub const UNKNOWN: cec_version = 0;
pub const _1_2: cec_version = 1;
pub const _1_2A: cec_version = 2;
pub const _1_3: cec_version = 3;
pub const _1_3A: cec_version = 4;
pub const _1_4: cec_version = 5;
pub const CEC_CHANNEL_NUMBER_FORMAT_MASK: cec_channel_identifier = -67108864;
...
pub const SKIP_FORWARD_WIND: cec_deck_control_mode = 1;
pub const SKIP_REVERSE_REWIND: cec_deck_control_mode = 2;
pub const STOP: cec_deck_control_mode = 3;
pub const EJECT: cec_deck_control_mode = 4;
pub const PLAY: cec_deck_info = 17;
pub const RECORD: cec_deck_info = 18;
pub const PLAY_REVERSE: cec_deck_info = 19;
pub const STILL: cec_deck_info = 20;
pub const SLOW: cec_deck_info = 21;
pub const SLOW_REVERSE: cec_deck_info = 22;
pub const FAST_FORWARD: cec_deck_info = 23;
pub const FAST_REVERSE: cec_deck_info = 24;
pub const NO_MEDIA: cec_deck_info = 25;
pub const STOP: cec_deck_info = 26;
pub const SKIP_FORWARD_WIND: cec_deck_info = 27;
pub const SKIP_REVERSE_REWIND: cec_deck_info = 28;
pub const INDEX_SEARCH_FORWARD: cec_deck_info = 29;
pub const INDEX_SEARCH_REVERSE: cec_deck_info = 30;
pub const OTHER_STATUS: cec_deck_info = 31;
pub const OTHER_STATUS_LG: cec_deck_info = 32;
pub const TV: cec_device_type = 0;
pub const RECORDING_DEVICE: cec_device_type = 1;
pub const RESERVED: cec_device_type = 2;
pub const TUNER: cec_device_type = 3;
pub const PLAYBACK_DEVICE: cec_device_type = 4;
pub const AUDIO_SYSTEM: cec_device_type = 5;
pub const DISPLAY_FOR_DEFAULT_TIME: cec_display_control = 0;
pub const DISPLAY_UNTIL_CLEARED: cec_display_control = 64;
pub const CLEAR_PREVIOUS_MESSAGE: cec_display_control = 128;
pub const RESERVED_FOR_FUTURE_USE: cec_display_control = 192;
pub const EXTERNAL_PLUG: cec_external_source_specifier = 4;
pub const EXTERNAL_PHYSICAL_ADDRESS: cec_external_source_specifier = 5;
pub const ACTIVATE: cec_menu_request_type = 0;
pub const DEACTIVATE: cec_menu_request_type = 1;
pub const QUERY: cec_menu_request_type = 2;
pub const ACTIVATED: cec_menu_state = 0;
pub const DEACTIVATED: cec_menu_state = 1;
pub const PLAY_FORWARD: cec_play_mode = 36;
pub const PLAY_REVERSE: cec_play_mode = 32;
pub const PLAY_STILL: cec_play_mode = 37;
pub const FAST_FORWARD_MIN_SPEED: cec_play_mode = 5;
pub const FAST_FORWARD_MEDIUM_SPEED: cec_play_mode = 6;
pub const FAST_FORWARD_MAX_SPEED: cec_play_mode = 7;
pub const FAST_REVERSE_MIN_SPEED: cec_play_mode = 9;
pub const FAST_REVERSE_MEDIUM_SPEED: cec_play_mode = 10;
pub const FAST_REVERSE_MAX_SPEED: cec_play_mode = 11;
pub const SLOW_FORWARD_MIN_SPEED: cec_play_mode = 21;
pub const SLOW_FORWARD_MEDIUM_SPEED: cec_play_mode = 22;
pub const SLOW_FORWARD_MAX_SPEED: cec_play_mode = 23;
pub const SLOW_REVERSE_MIN_SPEED: cec_play_mode = 25;
pub const SLOW_REVERSE_MEDIUM_SPEED: cec_play_mode = 26;
pub const SLOW_REVERSE_MAX_SPEED: cec_play_mode = 27;
pub const ON: cec_power_status = 0;
pub const STANDBY: cec_power_status = 1;
pub const IN_TRANSITION_STANDBY_TO_ON: cec_power_status = 2;
pub const IN_TRANSITION_ON_TO_STANDBY: cec_power_status = 3;
pub const UNKNOWN: cec_power_status = 153;
pub const OWN_SOURCE: cec_record_source_type = 1;
pub const DIGITAL_SERVICE: cec_record_source_type = 2;
pub const ANALOGUE_SERVICE: cec_record_source_type = 3;
pub const EXTERNAL_PLUS: cec_record_source_type = 4;
pub const EXTERNAL_PHYSICAL_ADDRESS: cec_record_source_type = 5;
pub const RECORDING_CURRENTLY_SELECTED_SOURCE: cec_record_status_info = 1;
pub const RECORDING_DIGITAL_SERVICE: cec_record_status_info = 2;
pub const RECORDING_ANALOGUE_SERVICE: cec_record_status_info = 3;
pub const RECORDING_EXTERNAL_INPUT: cec_record_status_info = 4;
pub const NO_RECORDING_UNABLE_TO_RECORD_DIGITAL_SERVICE: cec_record_status_info = 5;
pub const NO_RECORDING_UNABLE_TO_RECORD_ANALOGUE_SERVICE: cec_record_status_info = 6;
pub const NO_RECORDING_UNABLE_TO_SELECT_REQUIRED_SERVICE: cec_record_status_info = 7;
pub const NO_RECORDING_INVALID_EXTERNAL_PLUG_NUMBER: cec_record_status_info = 9;
pub const NO_RECORDING_INVALID_EXTERNAL_ADDRESS: cec_record_status_info = 10;
pub const NO_RECORDING_CA_SYSTEM_NOT_SUPPORTED: cec_record_status_info = 11;
pub const NO_RECORDING_NO_OR_INSUFFICIENT_ENTITLEMENTS: cec_record_status_info = 12;
pub const NO_RECORDING_NOT_ALLOWED_TO_COPY_SOURCE: cec_record_status_info = 13;
pub const NO_RECORDING_NO_FURTHER_COPIES_ALLOWED: cec_record_status_info = 14;
pub const NO_RECORDING_NO_MEDIA: cec_record_status_info = 16;
pub const NO_RECORDING_PLAYING: cec_record_status_info = 17;
pub const NO_RECORDING_ALREADY_RECORDING: cec_record_status_info = 18;
pub const NO_RECORDING_MEDIA_PROTECTED: cec_record_status_info = 19;
pub const NO_RECORDING_NO_SOURCE_SIGNAL: cec_record_status_info = 20;
pub const NO_RECORDING_MEDIA_PROBLEM: cec_record_status_info = 21;
pub const NO_RECORDING_NOT_ENOUGH_SPACE_AVAILABLE: cec_record_status_info = 22;
pub const NO_RECORDING_PARENTAL_LOCK_ON: cec_record_status_info = 23;
pub const RECORDING_TERMINATED_NORMALLY: cec_record_status_info = 26;
pub const RECORDING_HAS_ALREADY_TERMINATED: cec_record_status_info = 27;
pub const NO_RECORDING_OTHER_REASON: cec_record_status_info = 31;
pub const SUNDAY: cec_recording_sequence = 1;
pub const MONDAY: cec_recording_sequence = 2;
pub const TUESDAY: cec_recording_sequence = 4;
pub const WEDNESDAY: cec_recording_sequence = 8;
pub const THURSDAY: cec_recording_sequence = 16;
pub const FRIDAY: cec_recording_sequence = 32;
pub const SATURDAY: cec_recording_sequence = 64;
pub const ONCE_ONLY: cec_recording_sequence = 0;
pub const ON: cec_status_request = 1;
pub const OFF: cec_status_request = 2;
pub const ONCE: cec_status_request = 3;
pub const OFF: cec_system_audio_status = 0;
pub const ON: cec_system_audio_status = 1;
pub const TIMER_NOT_CLEARED_RECORDING: cec_timer_cleared_status_data = 0;
pub const TIMER_NOT_CLEARED_NO_MATCHING: cec_timer_cleared_status_data = 1;
pub const TIMER_NOT_CLEARED_NO_INF0_AVAILABLE: cec_timer_cleared_status_data = 2;
pub const TIMER_CLEARED: cec_timer_cleared_status_data = 128;
pub const NO_OVERLAP: cec_timer_overlap_warning = 0;
pub const TIMER_BLOCKS_OVERLAP: cec_timer_overlap_warning = 1;
pub const MEDIA_PRESENT_AND_NOT_PROTECTED: cec_media_info = 0;
pub const MEDIA_PRESENT_BUT_PROTECTED: cec_media_info = 1;
pub const MEDIA_NOT_PRESENT: cec_media_info = 2;
pub const FUTURE_USE: cec_media_info = 3;
pub const NOT_PROGRAMMED: cec_programmed_indicator = 0;
pub const PROGRAMMED: cec_programmed_indicator = 1;
pub const FUTURE_USE: cec_programmed_info = 0;
pub const ENOUGH_SPACE_AVAILABLE_FOR_RECORDING: cec_programmed_info = 8;
pub const NOT_ENOUGH_SPACE_AVAILABLE_FOR_RECORDING: cec_programmed_info = 9;
pub const MAY_NOT_BE_ENOUGH_SPACE_AVAILABLE: cec_programmed_info = 11;
pub const NO_MEDIA_INFO_AVAILABLE: cec_programmed_info = 10;
pub const FUTURE_USE: cec_not_programmed_error_info = 0;
pub const NO_FREE_TIMER_AVAILABLE: cec_not_programmed_error_info = 1;
pub const DATE_OUT_OF_RANGE: cec_not_programmed_error_info = 2;
pub const RECORDING_SEQUENCE_ERROR: cec_not_programmed_error_info = 3;
pub const INVALID_EXTERNAL_PLUG_NUMBER: cec_not_programmed_error_info = 4;
pub const INVALID_EXTERNAL_PHYSICAL_ADDRESS: cec_not_programmed_error_info = 5;
pub const CA_SYSTEM_NOT_SUPPORTED: cec_not_programmed_error_info = 6;
pub const NO_OR_INSUFFICIENT_CA_ENTITLEMENTS: cec_not_programmed_error_info = 7;
pub const DOES_NOT_SUPPORT_RESOLUTION: cec_not_programmed_error_info = 8;
pub const PARENTAL_LOCK_ON: cec_not_programmed_error_info = 9;
pub const CLOCK_FAILURE: cec_not_programmed_error_info = 10;
pub const RESERVED_FOR_FUTURE_USE_START: cec_not_programmed_error_info = 11;
pub const RESERVED_FOR_FUTURE_USE_END: cec_not_programmed_error_info = 13;
pub const DUPLICATE_ALREADY_PROGRAMMED: cec_not_programmed_error_info = 14;
pub const NOT_BEING_USED_FOR_RECORDING: cec_recording_flag = 0;
pub const BEING_USED_FOR_RECORDING: cec_recording_flag = 1;
pub const DISPLAYING_DIGITAL_TUNER: cec_tuner_display_info = 0;
pub const NOT_DISPLAYING_TUNER: cec_tuner_display_info = 1;
pub const DISPLAYING_ANALOGUE_TUNER: cec_tuner_display_info = 2;
pub const PAL_B_G: cec_broadcast_system = 0;
pub const SECAM_L1: cec_broadcast_system = 1;
pub const PAL_M: cec_broadcast_system = 2;
pub const NTSC_M: cec_broadcast_system = 3;
pub const PAL_I: cec_broadcast_system = 4;
pub const SECAM_DK: cec_broadcast_system = 5;
pub const SECAM_B_G: cec_broadcast_system = 6;
pub const SECAM_L2: cec_broadcast_system = 7;
pub const PAL_DK: cec_broadcast_system = 8;
pub const OTHER_SYSTEM: cec_broadcast_system = 30;
pub const SELECT: cec_user_control_code = 0;
pub const UP: cec_user_control_code = 1;
pub const DOWN: cec_user_control_code = 2;
pub const LEFT: cec_user_control_code = 3;
pub const RIGHT: cec_user_control_code = 4;
pub const RIGHT_UP: cec_user_control_code = 5;
pub const RIGHT_DOWN: cec_user_control_code = 6;
pub const LEFT_UP: cec_user_control_code = 7;
pub const LEFT_DOWN: cec_user_control_code = 8;
pub const ROOT_MENU: cec_user_control_code = 9;
pub const SETUP_MENU: cec_user_control_code = 10;
pub const CONTENTS_MENU: cec_user_control_code = 11;
pub const FAVORITE_MENU: cec_user_control_code = 12;
pub const EXIT: cec_user_control_code = 13;
pub const TOP_MENU: cec_user_control_code = 16;
pub const DVD_MENU: cec_user_control_code = 17;
pub const NUMBER_ENTRY_MODE: cec_user_control_code = 29;
pub const NUMBER11: cec_user_control_code = 30;
pub const NUMBER12: cec_user_control_code = 31;
pub const NUMBER0: cec_user_control_code = 32;
pub const NUMBER1: cec_user_control_code = 33;
pub const NUMBER2: cec_user_control_code = 34;
pub const NUMBER3: cec_user_control_code = 35;
pub const NUMBER4: cec_user_control_code = 36;
pub const NUMBER5: cec_user_control_code = 37;
pub const NUMBER6: cec_user_control_code = 38;
pub const NUMBER7: cec_user_control_code = 39;
pub const NUMBER8: cec_user_control_code = 40;
pub const NUMBER9: cec_user_control_code = 41;
pub const DOT: cec_user_control_code = 42;
pub const ENTER: cec_user_control_code = 43;
pub const CLEAR: cec_user_control_code = 44;
pub const NEXT_FAVORITE: cec_user_control_code = 47;
pub const CHANNEL_UP: cec_user_control_code = 48;
pub const CHANNEL_DOWN: cec_user_control_code = 49;
pub const PREVIOUS_CHANNEL: cec_user_control_code = 50;
pub const SOUND_SELECT: cec_user_control_code = 51;
pub const INPUT_SELECT: cec_user_control_code = 52;
pub const DISPLAY_INFORMATION: cec_user_control_code = 53;
pub const HELP: cec_user_control_code = 54;
pub const PAGE_UP: cec_user_control_code = 55;
pub const PAGE_DOWN: cec_user_control_code = 56;
pub const POWER: cec_user_control_code = 64;
pub const VOLUME_UP: cec_user_control_code = 65;
pub const VOLUME_DOWN: cec_user_control_code = 66;
pub const MUTE: cec_user_control_code = 67;
pub const PLAY: cec_user_control_code = 68;
pub const STOP: cec_user_control_code = 69;
pub const PAUSE: cec_user_control_code = 70;
pub const RECORD: cec_user_control_code = 71;
pub const REWIND: cec_user_control_code = 72;
pub const FAST_FORWARD: cec_user_control_code = 73;
pub const EJECT: cec_user_control_code = 74;
pub const FORWARD: cec_user_control_code = 75;
pub const BACKWARD: cec_user_control_code = 76;
pub const STOP_RECORD: cec_user_control_code = 77;
pub const PAUSE_RECORD: cec_user_control_code = 78;
pub const ANGLE: cec_user_control_code = 80;
pub const SUB_PICTURE: cec_user_control_code = 81;
pub const VIDEO_ON_DEMAND: cec_user_control_code = 82;
pub const ELECTRONIC_PROGRAM_GUIDE: cec_user_control_code = 83;
pub const TIMER_PROGRAMMING: cec_user_control_code = 84;
pub const INITIAL_CONFIGURATION: cec_user_control_code = 85;
pub const SELECT_BROADCAST_TYPE: cec_user_control_code = 86;
pub const SELECT_SOUND_PRESENTATION: cec_user_control_code = 87;
pub const PLAY_FUNCTION: cec_user_control_code = 96;
pub const PAUSE_PLAY_FUNCTION: cec_user_control_code = 97;
pub const RECORD_FUNCTION: cec_user_control_code = 98;
pub const PAUSE_RECORD_FUNCTION: cec_user_control_code = 99;
pub const STOP_FUNCTION: cec_user_control_code = 100;
pub const MUTE_FUNCTION: cec_user_control_code = 101;
pub const RESTORE_VOLUME_FUNCTION: cec_user_control_code = 102;
pub const TUNE_FUNCTION: cec_user_control_code = 103;
pub const SELECT_MEDIA_FUNCTION: cec_user_control_code = 104;
pub const SELECT_AV_INPUT_FUNCTION: cec_user_control_code = 105;
pub const SELECT_AUDIO_INPUT_FUNCTION: cec_user_control_code = 106;
pub const POWER_TOGGLE_FUNCTION: cec_user_control_code = 107;
pub const POWER_OFF_FUNCTION: cec_user_control_code = 108;
pub const POWER_ON_FUNCTION: cec_user_control_code = 109;
pub const F1_BLUE: cec_user_control_code = 113;
pub const F2_RED: cec_user_control_code = 114;
pub const F3_GREEN: cec_user_control_code = 115;
pub const F4_YELLOW: cec_user_control_code = 116;
pub const F5: cec_user_control_code = 117;
pub const DATA: cec_user_control_code = 118;
pub const AN_RETURN: cec_user_control_code = 145;
pub const AN_CHANNELS_LIST: cec_user_control_code = 150;
pub const MAX: cec_user_control_code = 150;
pub const UNKNOWN: cec_user_control_code = 255;
pub const UNKNOWN: cec_logical_address = -1;
pub const TV: cec_logical_address = 0;
pub const RECORDINGDEVICE1: cec_logical_address = 1;
pub const RECORDINGDEVICE2: cec_logical_address = 2;
pub const TUNER1: cec_logical_address = 3;
pub const PLAYBACKDEVICE1: cec_logical_address = 4;
pub const AUDIOSYSTEM: cec_logical_address = 5;
pub const TUNER2: cec_logical_address = 6;
pub const TUNER3: cec_logical_address = 7;
pub const PLAYBACKDEVICE2: cec_logical_address = 8;
pub const RECORDINGDEVICE3: cec_logical_address = 9;
pub const TUNER4: cec_logical_address = 10;
pub const PLAYBACKDEVICE3: cec_logical_address = 11;
pub const RESERVED1: cec_logical_address = 12;
pub const RESERVED2: cec_logical_address = 13;
pub const FREEUSE: cec_logical_address = 14;
pub const UNREGISTERED: cec_logical_address = 15;
pub const BROADCAST: cec_logical_address = 15;
pub const ACTIVE_SOURCE: cec_opcode = 130;
pub const IMAGE_VIEW_ON: cec_opcode = 4;
pub const TEXT_VIEW_ON: cec_opcode = 13;
pub const INACTIVE_SOURCE: cec_opcode = 157;
pub const REQUEST_ACTIVE_SOURCE: cec_opcode = 133;
pub const ROUTING_CHANGE: cec_opcode = 128;
pub const ROUTING_INFORMATION: cec_opcode = 129;
pub const SET_STREAM_PATH: cec_opcode = 134;
pub const STANDBY: cec_opcode = 54;
pub const RECORD_OFF: cec_opcode = 11;
pub const RECORD_ON: cec_opcode = 9;
pub const RECORD_STATUS: cec_opcode = 10;
pub const RECORD_TV_SCREEN: cec_opcode = 15;
pub const CLEAR_ANALOGUE_TIMER: cec_opcode = 51;
pub const CLEAR_DIGITAL_TIMER: cec_opcode = 153;
pub const CLEAR_EXTERNAL_TIMER: cec_opcode = 161;
pub const SET_ANALOGUE_TIMER: cec_opcode = 52;
pub const SET_DIGITAL_TIMER: cec_opcode = 151;
pub const SET_EXTERNAL_TIMER: cec_opcode = 162;
pub const SET_TIMER_PROGRAM_TITLE: cec_opcode = 103;
pub const TIMER_CLEARED_STATUS: cec_opcode = 67;
pub const TIMER_STATUS: cec_opcode = 53;
pub const CEC_VERSION: cec_opcode = 158;
pub const GET_CEC_VERSION: cec_opcode = 159;
pub const GIVE_PHYSICAL_ADDRESS: cec_opcode = 131;
pub const GET_MENU_LANGUAGE: cec_opcode = 145;
pub const REPORT_PHYSICAL_ADDRESS: cec_opcode = 132;
pub const SET_MENU_LANGUAGE: cec_opcode = 50;
pub const DECK_CONTROL: cec_opcode = 66;
pub const DECK_STATUS: cec_opcode = 27;
pub const GIVE_DECK_STATUS: cec_opcode = 26;
pub const PLAY: cec_opcode = 65;
pub const GIVE_TUNER_DEVICE_STATUS: cec_opcode = 8;
pub const SELECT_ANALOGUE_SERVICE: cec_opcode = 146;
pub const SELECT_DIGITAL_SERVICE: cec_opcode = 147;
pub const TUNER_DEVICE_STATUS: cec_opcode = 7;
pub const TUNER_STEP_DECREMENT: cec_opcode = 6;
pub const TUNER_STEP_INCREMENT: cec_opcode = 5;
pub const DEVICE_VENDOR_ID: cec_opcode = 135;
pub const GIVE_DEVICE_VENDOR_ID: cec_opcode = 140;
pub const VENDOR_COMMAND: cec_opcode = 137;
pub const VENDOR_COMMAND_WITH_ID: cec_opcode = 160;
pub const VENDOR_REMOTE_BUTTON_DOWN: cec_opcode = 138;
pub const VENDOR_REMOTE_BUTTON_UP: cec_opcode = 139;
pub const SET_OSD_STRING: cec_opcode = 100;
pub const GIVE_OSD_NAME: cec_opcode = 70;
pub const SET_OSD_NAME: cec_opcode = 71;
pub const MENU_REQUEST: cec_opcode = 141;
pub const MENU_STATUS: cec_opcode = 142;
pub const USER_CONTROL_PRESSED: cec_opcode = 68;
pub const USER_CONTROL_RELEASE: cec_opcode = 69;
pub const GIVE_DEVICE_POWER_STATUS: cec_opcode = 143;
pub const REPORT_POWER_STATUS: cec_opcode = 144;
pub const FEATURE_ABORT: cec_opcode = 0;
pub const ABORT: cec_opcode = 255;
pub const GIVE_AUDIO_STATUS: cec_opcode = 113;
pub const GIVE_SYSTEM_AUDIO_MODE_STATUS: cec_opcode = 125;
pub const REPORT_AUDIO_STATUS: cec_opcode = 122;
pub const SET_SYSTEM_AUDIO_MODE: cec_opcode = 114;
pub const SYSTEM_AUDIO_MODE_REQUEST: cec_opcode = 112;
pub const SYSTEM_AUDIO_MODE_STATUS: cec_opcode = 126;
pub const SET_AUDIO_RATE: cec_opcode = 154;
pub const REPORT_SHORT_AUDIO_DESCRIPTORS: cec_opcode = 163;
pub const REQUEST_SHORT_AUDIO_DESCRIPTORS: cec_opcode = 164;
pub const START_ARC: cec_opcode = 192;
pub const REPORT_ARC_STARTED: cec_opcode = 193;
pub const REPORT_ARC_ENDED: cec_opcode = 194;
pub const REQUEST_ARC_START: cec_opcode = 195;
pub const REQUEST_ARC_END: cec_opcode = 196;
pub const END_ARC: cec_opcode = 197;
pub const CDC: cec_opcode = 248;
pub const NONE: cec_opcode = 253;
...
pub const UNKNOWN: cec_bus_device_status = 0;
pub const PRESENT: cec_bus_device_status = 1;
pub const NOT_PRESENT: cec_bus_device_status = 2;
pub const HANDLED_BY_LIBCEC: cec_bus_device_status = 3;
pub const TOSHIBA: cec_vendor_id = 57;
pub const SAMSUNG: cec_vendor_id = 240;
pub const DENON: cec_vendor_id = 1485;
pub const MARANTZ: cec_vendor_id = 1656;
pub const LOEWE: cec_vendor_id = 2434;
pub const ONKYO: cec_vendor_id = 2480;
pub const MEDION: cec_vendor_id = 3256;
pub const TOSHIBA2: cec_vendor_id = 3303;
pub const APPLE: cec_vendor_id = 4346;
pub const PULSE_EIGHT: cec_vendor_id = 5506;
pub const HARMAN_KARDON2: cec_vendor_id = 6480;
pub const GOOGLE: cec_vendor_id = 6673;
pub const AKAI: cec_vendor_id = 8391;
pub const AOC: cec_vendor_id = 9319;
pub const PANASONIC: cec_vendor_id = 32837;
pub const PHILIPS: cec_vendor_id = 36926;
pub const DAEWOO: cec_vendor_id = 36947;
pub const YAMAHA: cec_vendor_id = 41182;
pub const GRUNDIG: cec_vendor_id = 53461;
pub const PIONEER: cec_vendor_id = 57398;
pub const LG: cec_vendor_id = 57489;
pub const SHARP: cec_vendor_id = 524319;
pub const SONY: cec_vendor_id = 524358;
pub const BROADCOM: cec_vendor_id = 1622150;
pub const SHARP2: cec_vendor_id = 5458000;
pub const VIZIO: cec_vendor_id = 7042157;
pub const BENQ: cec_vendor_id = 8414697;
pub const HARMAN_KARDON: cec_vendor_id = 10249310;
pub const UNKNOWN: cec_vendor_id = 0;
pub const UNKNOWN: cec_adapter_type = 0;
pub const P8_EXTERNAL: cec_adapter_type = 1;
pub const P8_DAUGHTERBOARD: cec_adapter_type = 2;
pub const RPI: cec_adapter_type = 256;
pub const TDA995x: cec_adapter_type = 512;
pub const EXYNOS: cec_adapter_type = 768;
pub const LINUX: cec_adapter_type = 1024;
pub const AOCEC: cec_adapter_type = 1280;
pub const IMX: cec_adapter_type = 1536;
pub const CURRENT: libcec_version = 327680;
pub const SERVICE_DEVICE: libcec_alert = 0;
pub const CONNECTION_LOST: libcec_alert = 1;
pub const PERMISSION_ERROR: libcec_alert = 2;
pub const PORT_BUSY: libcec_alert = 3;
pub const PHYSICAL_ADDRESS_ERROR: libcec_alert = 4;
pub const TV_POLL_FAILED: libcec_alert = 5;
pub const STRING: libcec_parameter_type = 0;
pub const UNKOWN: libcec_parameter_type = 1;
#[test]
...
fn bindgen_test_layout_libcec_configuration() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).bAutoPowerOn) as usize - ptr as usize },
        329usize,
        concat!(
            "Offset of field: ",
            stringify!(libcec_configuration),
            "::",
            stringify!(bAutoPowerOn)
        )
    );
}
